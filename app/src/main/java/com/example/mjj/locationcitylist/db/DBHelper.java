package com.example.mjj.locationcitylist.db;
 ...
 * <p>
 * 注意：execSQL不支持带;的多条SQL语句，只能一条一条的执行，原因
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // 数据库文件目标存放路径为系统默认位置，com.fireapp 是你的包名
    private static String DB_PATH = "/data/data/com.example.mjj.locationcitylist/databases/";

    /*
     * 如果你想把数据库文件存放在SD卡的话
     * private static String DB_PATH = android.os.Environment.getExternalStorageDirectory()
     * .getAbsolutePath() + "/arthurcn/drivertest/packfiles/";
     */
    ...
    /**
     * 如果数据库文件较大，使用FileSplit分割为小于1M的小文件 此例中分割为
     * hello.db.101 hello.db.102 hello.db.103
     */
    // 第一个文件名后缀
